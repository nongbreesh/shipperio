...
$config['facebook_app_id']              = '264773087388962';
$config['facebook_app_secret']          = 'e60a5a770262c887e87a10109a74c75a';
$config['facebook_login_type']          = 'web';
$config['facebook_login_redirect_url']  = 'login/fbaccess';
$config['facebook_logout_redirect_url'] = 'logout';
$config['facebook_permissions']         = array('public_profile', 'email'); //publish_actions
