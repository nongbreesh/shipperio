                ...
                <form class="form-horizontal new-lg-form" action="" method="post" enctype="multipart/form-data"
                    ...
                    <div class="form-group  m-t-20">
                        <div class="col-xs-12">
                            ...
                            <input class="form-control" type="text" name="firstname" required placeholder="First Name" value="<?= $name[0] ?>">
                        </div>
                    </div> 
                    ...
                    <div class="form-group  m-t-20">
                        <div class="col-xs-12">
                            ...
                            <input class="form-control" type="text" name="lastname" required placeholder="Last Name" value="<?= $name[1] ?>">
                        </div>
                    </div> 
                    <div class="form-group  m-t-20">
                        <div class="col-xs-12">
                            <label style="font-weight: bold;">อีเมลล์</label>
                            <input class="form-control" type="text" name="email" required placeholder="Email" value="<?= $email ?>" disabled>
                        </div>
                    </div> 
